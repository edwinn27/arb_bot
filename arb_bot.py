...
PROFIT_THRESHOLD_ETH = Decimal("0.01")
POLL_INTERVAL = 30.0
MAYAN_PROFIT_THRESHOLD_ETH = Decimal("0.015")  # wyższy próg dla Mayan
...
async def check_once(session):
    ...
    print(
        f"{color}[{now_ts()}] 2 ETH → {sol_amount:.6f} SOL ({bridge1}) → {eth_back:.6f} ETH ({bridge2}) | "
